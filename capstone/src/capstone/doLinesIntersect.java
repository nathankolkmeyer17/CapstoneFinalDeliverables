...
public class doLinesIntersect {
    ...
    /*****************************************/
    /* determines the crossproduct of two vectors from the origin.
    ...
    /* ************************************************************** */
    /* determines the dotproduct of two vectors from the origin.
       The vectors are represented as points.*/
    ...
    /* ******************************************************* */
    /* Determines if  segment (p1,p2) crosses  the line of segment (p3,p4).  
       From Cormen, Leiserson and Rivest, pg 889-890  */
    ...
    /* ******************************************************** */
    /* Determines if  segment (p1,p2) intesects  segment (p3,p4).  From 
       discussion in Cormen, Leiserson and Rivest, pg 889-890 */
    /* Assumes non-zero length segments */
    ...
    /**
     * Determines if the two edges cross each other.   Edges are defined to "cross" if the interior of the edge overlap.  
     * In particular, if the edges share an endpoint but no other points, then that is okay.  EG:  (1,1) -- (2,2)   and  (1,1) --- (1-2)
     * do not "cross" in this context.     However, (1,1) --- (2,2) and (1,0) --- (1,3) do cross because (1,1) is not an endpoint of the second edge.
     * @param e1 one of the edges
     * @param e2 the other edge
     * @return true if the two edges cross, subject to conditions above; false otherwise
     */
    ...
    {
      return( (long)(p.getX() - a.getX()) * (long)(b.getY() - a.getY()) < (long)(p.getY() - a.getY()) * (long)(b.getX() - a.getX()));
    }
